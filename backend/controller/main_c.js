const Faculty_Schema = require("../models/faculty_model");
...
exports.Faculty_Register = async (req, res) => {
  try {
    const data = await Faculty_Schema.create(req.body);
...
exports.Faculty_Login = async (req, res) => {
  try {
    const data = await Faculty_Schema.findOne({ email: req.body.email });
